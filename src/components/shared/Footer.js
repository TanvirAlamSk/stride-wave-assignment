...
const Footer = () => {
    return (
        <div className="relative flex justify-start md:justify-center md:items-end z-0">
            <img className="absolute object-cover top-10 h-full w-full xl:mt-10 z-0" src="https://i.ibb.co/ctKRMdw/footer-5-marketing-background.png" alt="background" />
            <div className="flex pt-36 md:pt-32 lg:pt-40 xl:pt-96   px-4 md:px-6  xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
                <div className="flex  flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
                    <div className="flex justify-start items-center space-x-4">
                        ...
                        <p className="w-60 text-xl xl:text-2xl font-semibold leading-normal text-white">Recipe Easy</p>
                    </div>
