...
const Status = () => {
    return (
        <div className="stats shadow stats-vertical md:stats-horizontal  w-full my-16">
            <div>
                <div className="stat">
                    ...
                    <div className="stat-value text-[#FF5C67]">1 Million+</div>
            ...
            <div>
                <div className="stat">
                    <div className="stat-figure text-[#FF5C67]">
                        {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg> */}
                        <SiCodechef className="inline-block w-12 h-12 stroke-current text-rose-500" />
                    </div>
            ...
            <div>
                <div className="stat">
                    ...
                    <div className="stat-value text-[#FF5C67]"> 98%</div>
